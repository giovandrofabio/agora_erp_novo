...
class ItemordemcompraController extends Controller {
    ...
    public function inserir()
    {
        ...
        $item_ordem_compra->id_item_ordem_compra  = isset($_POST["id_item_ordem_compra"]) ? $_POST["id_item_ordem_compra"] : null;
        $item_ordem_compra->id_item_ordem_compra  = $_POST["id_item_ordem_compra"];
        ...
        Flash::setForm($item_ordem_compra);
