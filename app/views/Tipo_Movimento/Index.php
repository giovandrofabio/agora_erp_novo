    ...
    <div class="col-12">
        <div class="caixa">
            <div
                ...
                <div>
                    <a href="<?php echo URL_BASE . "tipomovimento/create" ?>" class="btn btn-verde mx-1 d-inline-block"><i
                    ...
                    <tbody>
                        <?php 
                            foreach($lista as $tipo){
                                ...
                                $movimenta_estoque = ($tipo->movimenta_estoque == "S") ? "Sim" : "Não";
                        ?>
                        <tr>
                            ...
                            <td align="center"><?php echo $movimenta_estoque ?></td>

                            <td align="center"><a href="<?php echo URL_BASE . "tipomovimento/edit/".$tipo->id_tipo_movimento ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno">
                                <i class="fas fa-edit"></i> Editar</a> 
                            </td>
                            <td align="center"><a href="javascript:;" onclick="return excluir(this)" data-entidade="tipomovimento" data-id="<?php echo $tipo->id_tipo_movimento ?>"
