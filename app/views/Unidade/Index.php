    ...
    <div class="col-12">
        <div class="caixa">
            <div
                ...
                <div>
                    <a href="<?php echo URL_BASE ."unidade/create" ?>" class="btn btn-verde mx-1 d-inline-block"><i
                ...
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?php echo URL_BASE ."unidade/edit/" . $unidade->id_unidade ?>"
                                    class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i>
                                    Editar</a> </td>
                            <td align="center">
                                <a href="javascript:;" onclick="return excluir(this)" data-entidade="unidade" data-id="<?php echo $unidade->id_unidade ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno">
