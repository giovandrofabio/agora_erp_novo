        ...
        <div class="caixa">
            <div
                ...
                <div>
                    ...
                    <a href="" class="btn btn-azul filtro mx-1 d-inline-block">
                ...
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?php echo URL_BASE ."categoria/edit/" . $categoria->id_categoria ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno">
                                    <i class="fas fa-edit"></i> Editar</a> 
                            </td>
                            <td align="center">
                                <a href="javascript:;" onclick="return excluir(this)" data-entidade="categoria" data-id="<?php echo $categoria->id_categoria ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno">
