        ...
        <div class="caixa">
            <div
                ...
                <span class="d-flex center-middle">
                    <i class="far fa-list-alt mr-1"></i> Lista de produto
                </span>
                <div>
                    <a href="<?php echo URL_BASE ."produto/create" ?>" class="btn btn-verde mx-1 d-inline-block">
                ...
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><img src="<?php echo URL_IMAGEM . $imagem ?>" class="img-fluido radius-circulo opaco" width="40"></td>
                            ...
                            <td align="center"><a href="<?php echo URL_BASE ."produto/edit/" .$produto->id_produto ?>"
                                    class="d-inline-block btn btn-outline-roxo btn-pequeno img-fluido"><i
                                        class="fas fa-edit"></i> Editar</a> </td>
                            <td align="center">
                                <a href="javascript:;" onclick="return excluir(this)" data-entidade="produto" data-id="<?php echo $produto->id_produto ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno">
